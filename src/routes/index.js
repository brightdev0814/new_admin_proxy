...
const credentialCtrl = require("../controllers/credentialCtrl");
...
router.get("/api/credentials/:service", credentialCtrl.fetch);
...
router.delete("/api/logs/:name", logCtrl.deleteLog);
