  ...
  try {
    ...
    if (data.isSuccessful) {
      if (data.clientState.user.isLoggedIn) {
        ...
        spyfuLog.info(`Start session with ${email} successfully.`);
